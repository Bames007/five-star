...
function CardStack({ items, onCardSelect }: CardStackProps) {
  ...
  const getCategoryIcon = (category: string) => {
    const icons: { [key: string]: React.ReactNode } = {
      Wine: <Wine size={isMobile ? 14 : 16} />,
      Beer: <Beer size={isMobile ? 14 : 16} />,
      Cocktail: <CupSoda size={isMobile ? 14 : 16} />,
      "Non-Alcoholic": <Coffee size={isMobile ? 14 : 16} />,
      Champagne: <Sparkles size={isMobile ? 14 : 16} />,
      Sake: <Wine size={isMobile ? 14 : 16} />,
      Spirit: <Sparkles size={isMobile ? 14 : 16} />,
      Digestif: <Wine size={isMobile ? 14 : 16} />,
    };
    return icons[category] || <Sparkles size={isMobile ? 14 : 16} />;
  };
  ...
  const getCardOffsets = () => {
    if (isMobile) {
      return {
        x: 60, // Further reduced for better mobile experience
        y: 10,
        activeScale: 0.85, // Increased active card size
    ...
    <div className="relative w-full max-w-4xl mx-auto h-[400px] md:h-[600px] px-2 md:px-4">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-3 md:p-6">
                ...
                <div className="flex justify-between items-start mb-2 md:mb-4">
                  ...
                  <span className="bg-black/80 text-white px-2 py-0.5 rounded text-xs md:text-sm backdrop-blur-sm">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-1 md:gap-2 mb-2 md:mb-4">
                        <span className="text-xs bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded-full border border-blue-500/30">
                          {isMobile
                            ? item.country_of_origin.substring(0, 10) + "..."
      ...
      <div className="absolute -bottom-12 md:-bottom-30 left-1/2 transform -translate-x-1/2 flex space-x-2 md:space-x-4 items-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.85 }}
          onClick={() => navigate(-1)}
          className="group w-10 h-10 md:w-14 md:h-14 bg-gray-900/90 rounded-full flex items-center justify-center shadow-xl border border-[#DDA629]/30 hover:border-[#DDA629] transition-all duration-300 backdrop-blur-sm"
        >
          <ChevronLeft
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-x-hidden">
      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          >
            Discover our exquisite selection of premium drinks. Tap or swipe to
            explore.
          </p>
        </motion.div>
      </div>
